...
public class Fenetre extends JFrame {
	 ...
	 * Le bouton
	 */
	private JButton load = new JButton("Run script");
	...
	public void initTable(String query) {
		try {
			...
			Statement state = SdzConnection.getInstance().createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,
			...
			result.add(new JLabel(
					"La requête à été exécuter en " + totalTime + " ms et a retourné " + rowCount + " ligne(s)"),
					BorderLayout.SOUTH);
